...
Teacher-centric quiz platform: create quizzes (form, CSV, AI), then play them as classroom PixiJS games (multiple-choice, Splash Dash, and Word Play drag-and-drop) with teams, timers, scoring, themes, and power-ups.
...
src/lib/pixi-games/     Game implementations (multiple-choice, splash-dash, word-play)
...
| **Word Play (drag & drop)** | [src/lib/pixi-games/word-play/README.md](src/lib/pixi-games/word-play/README.md) | SORTING/MATCHING gameplay, drag-drop controls |
