 ...
 * This maintains compatibility with the PixiJS version.
 */
 ...
 * 
 * This is a direct port from the PixiJS version, maintaining the same interface
 * and behavior while being compatible with Phaser's scene-based architecture.
 */
