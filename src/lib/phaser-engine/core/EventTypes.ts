 ...
 * used throughout the Phaser engine EventBus.
 * 
 * This maintains compatibility with the PixiJS engine event system
 * to allow for seamless migration and consistent event handling.
 */
