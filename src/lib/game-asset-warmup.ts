...
export function getNinjaClimbSceneAssetUrls(): string[] {
  return [
    ...
    '/images/ninja-climb/deco_tree.png',
    '/images/ninja-climb/deco_bush.png',
    '/images/ninja-climb/deco_hut.png',
    ...
    '/images/ninja-climb/ninja_blue_idle_b.png',
    ...
    '/images/ninja-climb/ninja_red_idle_b.png',
